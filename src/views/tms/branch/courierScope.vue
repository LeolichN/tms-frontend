        ...
        <div>
            <el-table :header-cell-style="{ background: 'rgb(238, 238, 238)', color: 'black' }" ref="multipleTable"
                ...
                <el-table-column prop="id" fixed="right" align="center" label="操作">
                    <template v-slot="tt">
                        <el-button size="mini" icon="el-icon-edit" @click="courierScopDetail(tt.row)"
                            type="warning">作业范围分配</el-button>
                        <el-button size="mini" icon="el-icon-edit" @click="xiangqing(tt.row, dialogVisible = true)"
                            type="danger">快递员详情</el-button>
                    </template>
                </el-table-column>
