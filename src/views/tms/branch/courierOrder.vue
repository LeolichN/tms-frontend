    ...
    <el-tabs type="border-card">
        ...
        <el-tab-pane label="取件作业">
            ...
            <el-form :inline="true" :label-position="labelPosition"  >
                    ...
                    <div style="width:330px;">
                        <el-select v-model="PdTickupAndOrderpai.senderProvinceId" @change="shishow" placeholder="请选择" style="width: 30%;">
                                    <el-option  v-for="(item, index) in sheng" :key="index" :label="item.name" :value="item.id"></el-option>
                        </el-select>
                          <el-select placeholder="请选择" @change="qushow" v-model="PdTickupAndOrderpai.senderCityId" style="width: 30%;margin-left: 8px;">
                            <el-option v-for="(item, index) in shilist" :key="index" :label="item.name" :value="item.id"></el-option>
                        </el-select>                   
                        <el-select placeholder="请选择" v-model="PdTickupAndOrderpai.senderCountyId" style="width: 30%;margin-left: 8px;">
        ...
        <el-tab-pane label="派件作业">
            ...
            <el-form :inline="true" :label-position="labelPosition"  >
                    ...
                    <div style="width:330px;">
                        <el-select v-model="PdTickupAndOrder.receiverProvinceId" @change="shoushishow" placeholder="请选择" style="width: 30%;">
                                    <el-option  v-for="(item, index) in sheng" :key="index" :label="item.name" :value="item.id"></el-option>
                        </el-select>
                          <el-select placeholder="请选择" @change="shouqushow" v-model="PdTickupAndOrder.receiverCityId" style="width: 30%;margin-left: 8px;">
                            <el-option v-for="(item, index) in shoushilist" :key="index" :label="item.name" :value="item.id"></el-option>
                        </el-select>                   
                        <el-select placeholder="请选择" v-model="PdTickupAndOrder.receiverCountyId" style="width: 30%;margin-left: 8px;">
                            <el-option v-for="(item, index) in shouqulist" :key="index" :label="item.name" :value="item.id"></el-option>
                        </el-select>        
        ...
        <el-dialog
                        ...
                        width="50%">
                              ...
                              快递员：<el-select placeholder="请选择" v-model="courierid" style="width: 30%;margin-left: 8px;">
                                            <el-option v-for="(item, index) in querycourieridlist" :key="index" :label="item.name" :value="item.id"></el-option>
                                        </el-select>
