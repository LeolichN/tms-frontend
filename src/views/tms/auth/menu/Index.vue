...
<script>
import commonTree from '@/components/tms/CommonTree.vue'
    ...
    menuComponent() {
      ...
      if (this.menu.path && this.menu.path !== '/') {
        ...
        if (isUrl) {
          ...
          comp = `前端组件：tms${this.menu.path}/Index.vue`
        }
      } else {
        comp = `前端组件：tms/Index.vue`
      }
      return comp
    }
  },
  ...
  methods: {
    ...
    computedComponent() {
      ...
      if (isUrl) {
        ...
        if (this.menu.path) {
          this.menu.component = `tms${this.menu.path}/Index`
        } else {
          this.menu.component = `tms/Index`
        }
      }
    },
    initMenuTree() {
